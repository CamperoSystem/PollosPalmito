...
<body>
  ...
  <main class="contenedor-productos">
    <!-- Cada producto -->
    <div class="producto">
      <img src="assets/imagenes/papasfritas.png" alt="papas fritas">
      <h3>PAPAS FRITAS</h3>
      <p class="precio">Bs.14</p>
      <div class="cantidad">
    ...
    <div class="producto">
      <img src="assets/imagenes/arroz.png" alt="arroz">
      <h3>arroz con frijoles</h3>
    ...
    <div class="producto">
      <img src="assets/imagenes/salsa.png" alt="Salsa king dom">
      <h3>SALSA KING DOM</h3>
      <p class="precio">Bs.6</p>
      <div class="cantidad">
        <button onclick="restar(this)">-</button>
        <span class="contador">0</span>
        <button onclick="sumar(this)">+</button>
